...
; Generated by Kai Wicker on 22.01.2019 (UTC)
;
[Setup]
AppID={{05bb3ab5-49bf-4aaf-a287-5ca1f168efc9}
AppName=ASCOM NanoTempHUM ObservingConditions Driver
AppVerName=ASCOM NanoTempHUM ObservingConditions Driver 1.1.1
AppVersion=1.1.1
AppPublisher=Kai Wicker <kai@photonenfangen.de>
AppPublisherURL=mailto:kai@photonenfangen.de
...
OutputDir="."
OutputBaseFilename="NanoTempHUM Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\ObservingConditions\NanoTempHUM"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\ObservingConditions\NanoTempHUM"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\astro\Documents\Visual Studio 2017\Projects\ArduinoTempHumV2\ArduinoTempHum\bin\Release\ASCOM.ArduinoTempHum.ObservingConditions.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\astro\Documents\Visual Studio 2017\Projects\ArduinoTempHumV2\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ArduinoTempHum.ObservingConditions.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ArduinoTempHum.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.ArduinoTempHum.ObservingConditions.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ArduinoTempHum.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.ArduinoTempHum.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
